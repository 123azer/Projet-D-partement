...
<a th:href=@{list} style="margin-left: 80px;  front-size:16px; color:#0000ff;"> Inventaire</a><a style="front-size=:16px; color:#0000ff;"> > Ajout </a></div>
	<form th:action="@{saveArticle}" method="post" th:object="${a}">
		<div class="row">
			<div class="col s12 m6 l3"></div>
			<div class="col s12 m6 l3">
				<label class="control-label">Réferentiel:</label> <input type="text"
		...
		<div class="row">
			<div class="col s12 m6 l3"></div>
			<div class="col s12 m6 l3">
				<label class="control-label">Article:</label> <input required type="text"
